...
<head>
    ...
    <style>
        ...
        .qr-box {
            ...
            background: repeating-conic-gradient(var(--orange-subtle) 0% 25%, transparent 0% 50%) 50% / 8px 8px;
            flex-shrink: 0;
            transition: all .3s ease;
        }
        ...
        .totals .trow.grand {
            ...
            border-radius: 10px;
            align-items: center;
            box-shadow: 0 8px 20px -8px var(--orange-shadow);
        }
...
<body>
    ...
    <script>
        ...
        const invNo = document.getElementById('invNo').textContent.trim();
        if (!invNo) { window.print(); return; }
        window.open('generate_invoice_pdf.php?invoice_number=' + encodeURIComponent(invNo) + '&download=1', '_blank');
        });
